...
<head>
    ...
    <style>
        ...
        .badge { font-size: 11px; font-weight: 700; background: rgba(0, 128, 128, 0.1); color: var(--tg-theme-button-color, #008080); padding: 5px 12px; border-radius: 20px; white-space: nowrap; }
        .badge-global { background: #10b981; color: #ffffff; box-shadow: 0 2px 6px rgba(16, 185, 129, 0.2); }
        .input-field { width: 100%; padding: 14px; border-radius: 12px; border: 2px solid rgba(16, 185, 129, 0.2); font-size: 16px; margin-top: 10px; box-sizing: border-box; background: var(--tg-theme-bg-color, #fafafa); color: var(--tg-theme-text-color, #1f2937); }
